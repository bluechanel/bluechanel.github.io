...
pageId: 1738c66d-44b6-45a1-bfeb-f50062d3efec
description: 记录Langgraph使用过程中遇到的问题以及解决方法
date: 2024-09-11
updateDate: 2026-08-19
tags: [LangGraph]
cover: cover/1738c66d-44b6-45a1-bfeb-f50062d3efec_9d66b50af6cba34e5b96c55454c6012b.png
---
...
![local_imager_example.png](images/1738c66d-44b6-45a1-bfeb-f50062d3efec/1738c66d-44b6-45a1-bfeb-f50062d3efec_c027ef1255359cc82b1711f78c2395c6.png)
...
子图直接继承父图的State，所以子图可以方便的{% mark color="red" %}**获取**{% /mark %}和{% mark color="red" %}**重写**{% /mark %}父图的State，同时可以有自己的State
