...
pageId: 1f3605ee-e889-808e-bedf-d661f0d90b42
...
![%E5%BE%AE%E8%B0%83%E6%88%90%E5%8A%9F%E7%A7%98%E7%B1%8Dbak.png](images/1f3605ee-e889-808e-bedf-d661f0d90b42/1f3605ee-e889-808e-bedf-d661f0d90b42_ffa437a6a465a1a47f94cef04321674b.png)
...
![%E8%B7%AF%E5%BE%84.jpg](images/1f3605ee-e889-808e-bedf-d661f0d90b42/1f3605ee-e889-808e-bedf-d661f0d90b42_4ed2f9b07393bbc10660dee43170d177.jpg)
...
> 💡 {% mark color="red" %}**高质量**{% /mark %}且与{% mark color="red" %}**任务高度相关**{% /mark %}的数据是确保微调模型达到预期性能、准确性和特定行为模式的基石。数据质量直接决定了模型学习的**细微差别**、可能继承或减轻的偏见，以及其泛化能力。业界普遍认同“{% mark color="red" %}**输入垃圾，输出垃圾**{% /mark %}”的原则，这在LLM微调中尤为突出。


> 💡 {% mark color="red" %}**微调数据集的质量对模型性能的影响，往往比预训练语料库的绝对规模更为显著。**{% /mark %}


> 💡 {% mark color="red" %}**小规模**{% /mark %}**、**{% mark color="red" %}**高质量**{% /mark %}**、**{% mark color="red" %}**任务针对性强**{% /mark %}的微调数据集能够带来{% mark color="red" %}**显著的性能提升**{% /mark %}。
> 
> {% mark color="yellow" %}**低质量**{% /mark %}的微调数据甚至可能导致性能下降，例如{% mark color="yellow" %}**灾难性遗忘**{% /mark %}或{% mark color="yellow" %}**偏见放大**{% /mark %}。
