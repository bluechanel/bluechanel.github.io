...
pageId: c8a30e22-25df-414c-aa1d-2582622256e5
description: 本文介绍了如何修改FastChat以支持工具调用和LangGraph适配FastChat的问题。针对with_structured_output方法返回None的问题，提供了两种解决方案：使用chain替换该方法或继承ChatOpenAI并重写该方法。对于LangGraph的create_react_agent不能调用工具的问题，也提供了两种解决方案：修改FastChat接口以支持tools参数或替换create_react_agent方法。
date: 2024-05-08
...
代码较多，已提交到[github](https://github.com/bluechanel/FastChat)
