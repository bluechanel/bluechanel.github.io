        ...
        >
            <div className="max-w-6xl mx-auto px-4 lg:px-8">
                <div className="relative flex items-center justify-center h-16">
                    ...
                    <button
                        className="absolute left-0 p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 md:hidden"
                    ...
                    <div
                        className={clsx(
                            "hidden md:flex relative items-center space-x-6 transition-colors duration-300",
                            !isScrolled
                    ...
                    >
                        {items.map((item) => (
                            <Link
                                ...
                                id={`link-${item.route}`}
                                href={item.route}
                                className={`relative pb-1 transition-colors duration-300 ${isActive(item.route)
                                    ? "text-blue-500"
            ...
            <AnimatePresence>
                {isMobileMenuOpen && (
                    <motion.div
                        ...
                        className="md:hidden overflow-hidden border-t border-gray-200/50 dark:border-gray-800/50 bg-gray-100/95 dark:bg-gray-950/95 backdrop-blur-lg"
                    >
