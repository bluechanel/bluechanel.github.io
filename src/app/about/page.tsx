          ...
          <main className="lg:col-span-3 space-y-12">
            ...
            <section className="space-y-6">
              ...
              <div className="prose dark:prose-invert max-w-none text-gray-600 dark:text-gray-300 leading-relaxed">
                <p>
                  Hi，我是 Wiley。一名对<strong>人工智能</strong>和
                  <strong>大型语言模型</strong>怀抱热情的开发者。
                </p>
                <p>
                  我坚信<em>“AI 之初，性本善”</em>，AI 有能力改变世界。
                </p>
                <p>
                  目前，我专注于构建智能 Agent，并深入探索最新 LLM
                  的潜力。我坚信知识分享是推动技术进步的关键。
                </p>
                <p>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3 p-3 bg-white dark:bg-gray-900 rounded-lg border border-gray-100 dark:border-gray-800">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">M5, 32GB RAM</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3 p-3 bg-white dark:bg-gray-900 rounded-lg border border-gray-100 dark:border-gray-800">
                      <div className="mt-1">
            ...
            <section className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="bg-white dark:bg-gray-900 p-5 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Next.js", "React", "FastAPI", "LangChain"].map(
                      (item) => (
                        <span
                          key={item}
                          className="px-3 py-1 text-sm bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-full"
                ...
                <div className="bg-white dark:bg-gray-900 p-5 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["OpenAI API", "Claude Code", "RAG", "Agents", "MCP"].map(
                      (item) => (
                        <span
                          key={item}
                          className="px-3 py-1 text-sm bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-full"
